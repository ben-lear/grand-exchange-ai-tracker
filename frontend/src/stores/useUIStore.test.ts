...
describe('useUIStore', () => {
  ...
  describe('Initial State', () => {
    it('should have correct initial values', () => {
      ...
      expect(state.searchModalOpen).toBe(false);
  ...
  describe('Search Modal', () => {
    it('should toggle search modal', () => {
      const { toggleSearchModal } = useUIStore.getState();
    ...
    it('should set search modal open state', () => {
      const { setSearchModalOpen } = useUIStore.getState();
