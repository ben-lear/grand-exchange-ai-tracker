...
export const DEFAULT_COLUMNS = ['name', 'highPrice', 'lowPrice', 'avgPrice', 'members', 'buyLimit'];
export const ALL_COLUMNS = ['name', 'highPrice', 'lowPrice', 'avgPrice', 'members', 'buyLimit', 'highAlch'];
