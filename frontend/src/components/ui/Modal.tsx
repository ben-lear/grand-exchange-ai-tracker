...
const modalVariants = cva(
  'relative bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-hidden flex flex-col',
  {
    variants: {
      size: {
...
const modalFooterVariants = cva(
  'flex items-center justify-end gap-2 p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0'
);
...
export { modalVariants, backdropVariants, modalHeaderVariants, modalBodyVariants, modalFooterVariants };