    ...
    render: () => {
        ...
        return (
            <AnimatedDropdown
                ...
                trigger={
                    <Button onClick={() => setIsOpen(!isOpen)}>
                        Wide Menu <ChevronDown className="ml-2 h-4 w-4" />
                    </Button>
                }
                width="lg"
            >
                <AnimatedDropdownItem onClick={() => { }}>Action 1</AnimatedDropdownItem>
                <AnimatedDropdownItem onClick={() => { }}>Action 2</AnimatedDropdownItem>
                <AnimatedDropdownItem onClick={() => { }}>Action 3</AnimatedDropdownItem>
            </AnimatedDropdown>
        );
    },
};
