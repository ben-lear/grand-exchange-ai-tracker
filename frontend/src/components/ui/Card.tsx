  ...
  'rounded-lg',
  {
    variants: {
      variant: {
        ...
        // Error state card
        error: 'bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-900',
        
        // Warning state card
        warning: 'bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-900',
        
        // Success state card
        success: 'bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-900',
        
        // Info state card
        info: 'bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-900',
      },
      padding: {
        none: '',
        sm: 'p-3',
...
const cardFooterVariants = cva(
  'flex items-center justify-end gap-2',
  {
    variants: {
      ...
      borderTop: {
        true: 'border-t border-gray-200 dark:border-gray-700',
        false: '',
      },
    },
    defaultVariants: {
