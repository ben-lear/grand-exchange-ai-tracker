...
vi.mock('@/components/watchlist/CreateWatchlistModal/CreateWatchlistModal', () => ({
...
vi.mock('@/components/watchlist/ImportWatchlistModal/ImportWatchlistModal', () => ({
...
vi.mock('@/components/watchlist/ShareWatchlistModal/ShareWatchlistModal', () => ({
...
vi.mock('@/components/watchlist/WatchlistCard/WatchlistCard', () => ({
...
describe('WatchlistPage', () => {
    ...
    describe('State Management', () => {
        ...
        it('should update when store data changes', () => {
            ...
            const { rerender } = renderWithRouter(<WatchlistPage />);
    ...
    describe('Empty State', () => {
        it('should handle empty watchlist array gracefully', () => {
            ...
            const { container } = renderWithRouter(<WatchlistPage />);
